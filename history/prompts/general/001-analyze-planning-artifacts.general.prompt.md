---
id: 001
title: analyze-planning-artifacts
stage: general
date: 2026-01-01
surface: agent
...
links:
  ...
  pr: null
files:
  - history/prompts/general/001-analyze-planning-artifacts.general.prompt.md
tests: []
---
...
- ✅ Impact: Error reported correctly
- 🧪 Tests: None
- 📁 Files: None
- 🔁 Next prompts: /sp.plan or proceed with manual implementation
- 🧠 Reflection: User attempted to run ADR analysis without a plan.md file. This is a common workflow error.

## Evaluation notes (flywheel)

- Failure modes observed: Missing prerequisites (plan.md)
- Graders run and results (PASS/FAIL): PASS
- Prompt variant (if applicable): default
- Next experiment (smallest change to try): Improve error message to suggest creating plan or skipping if ad-hoc.
